...
1. la **estructura de archivos**: carpetas y división de las entradas;
2. el **sistema de interconexión** de las notas.

Haga clic para expandir la pestaña correspondiente:
...
> 
> Se trata de una frase extraída de una transcripción donde se destaca el enlace (en este caso, de "Ale en Red 11"). Este vínculo hace referencia a un párrafo —o **bloque**— completo que se encuentra dentro de la transcripción.
> 
